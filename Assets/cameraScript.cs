...
public class cameraScript : MonoBehaviour 
{
	...
	void Update()
	{
		...
		{
			gameObject.transform.Translate (new Vector3 (-1f, 0.0f, 0.0f));
		}
		...
		{
			gameObject.transform.Translate (new Vector3 (0f, 1f, 0.0f));
		}
		...
		{
			gameObject.transform.Translate (new Vector3 (0f, 0.0f, -1f));
		}
		...
		{
			gameObject.transform.Rotate (new Vector3 (0f, -5f, 0f));
		}
		...
		{
			gameObject.transform.Rotate (new Vector3 (-5f, 0.0f, 0f));
		}
